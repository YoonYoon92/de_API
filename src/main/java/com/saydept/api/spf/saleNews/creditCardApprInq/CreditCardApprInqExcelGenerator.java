...
public class CreditCardApprInqExcelGenerator {
   public static ByteArrayInputStream customersToExcel(List<CreditCardApprInqModel> reportModels) throws IOException {
...
//         ageCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("#,##0;[RED]-#,##0"));
         ...
         int rowIdx = 1;
         for (CreditCardApprInqModel reportModel : reportModels) {
