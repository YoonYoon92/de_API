...
public class PcEnuriInqExcelGenerator {
   public static ByteArrayInputStream customersToExcel(List<PcEnuriInqModel> reportModels) throws IOException {
...
//         ageCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("#,##0;[RED]-#,##0"));
         ...
         int rowIdx = 1;
         for (PcEnuriInqModel reportModel : reportModels) {
