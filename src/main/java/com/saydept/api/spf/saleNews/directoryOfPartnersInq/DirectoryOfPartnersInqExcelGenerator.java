...
public class DirectoryOfPartnersInqExcelGenerator {
   public static ByteArrayInputStream customersToExcel(List<DirectoryOfPartnersInqModel> reportModels) throws IOException {
...
//         ageCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("#,##0;[RED]-#,##0"));
         ...
         int rowIdx = 1;
         for (DirectoryOfPartnersInqModel reportModel : reportModels) {
