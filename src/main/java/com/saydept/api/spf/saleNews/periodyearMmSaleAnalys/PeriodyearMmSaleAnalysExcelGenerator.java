...
public class PeriodyearMmSaleAnalysExcelGenerator {
   public static ByteArrayInputStream customersToExcel(List<PeriodyearMmSaleAnalysModel> reportModels) throws IOException {
...
//         ageCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("#,##0;[RED]-#,##0"));
         ...
         int rowIdx = 1;
         for (PeriodyearMmSaleAnalysModel reportModel : reportModels) {
