...
public class ClsPlnNetSaleSltExcelGenerator {
   public static ByteArrayInputStream customersToExcel(List<ClsPlnNetSaleSltModel> reportModels) throws IOException {
...
//         ageCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("#,##0;[RED]-#,##0"));
         ...
         int rowIdx = 1;
         for (ClsPlnNetSaleSltModel reportModel : reportModels) {
