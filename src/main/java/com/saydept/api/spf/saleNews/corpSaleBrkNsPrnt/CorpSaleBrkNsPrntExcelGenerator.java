...
public class CorpSaleBrkNsPrntExcelGenerator {
   public static ByteArrayInputStream customersToExcel(List<CorpSaleBrkNsPrntModel> reportModels) throws IOException {
	   String[] COLUMNs = { "ClsNm", "ThisYySplan", "ThisYyNetsale","ThisYyAchivmentrate", "LastYySplan", "LastYyNetsale", "LastYyAchivmentrate" };
...
//          cell.setCellFormula(strFormula);
      ...
      // CellStyle 소수셀용
         CellStyle ageCellStyle2 = workbook.createCellStyle();
         ageCellStyle2.setDataFormat(createHelper.createDataFormat().getFormat("##,##0.00"));
//         ageCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("#,##0;[RED]-#,##0"));

         int rowIdx = 1;
         for (CorpSaleBrkNsPrntModel reportModel : reportModels) {
...
//            row.createCell(2).setCellValue(reportModel.getCls());
            ...
            getThisYyAchivmentrate.setCellStyle(ageCellStyle2);
            ...
            getLastYyAchivmentrate.setCellStyle(ageCellStyle2);
