...
public class RcptNoDanPumInqExcelGenerator {
   public static ByteArrayInputStream customersToExcel(List<RcptNoDanPumInqModel> reportModels) throws IOException {
...
//         ageCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("#,##0;[RED]-#,##0"));
         ...
         int rowIdx = 1;
         for (RcptNoDanPumInqModel reportModel : reportModels) {
