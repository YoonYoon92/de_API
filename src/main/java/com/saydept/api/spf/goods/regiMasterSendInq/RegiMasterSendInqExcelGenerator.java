...
public class RegiMasterSendInqExcelGenerator {
   public static ByteArrayInputStream customersToExcel(List<RegiMasterSendInqModel> reportModels) throws IOException {
...
//         ageCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("#,##0;[RED]-#,##0"));
         ...
         int rowIdx = 1;
         for (RegiMasterSendInqModel reportModel : reportModels) {
