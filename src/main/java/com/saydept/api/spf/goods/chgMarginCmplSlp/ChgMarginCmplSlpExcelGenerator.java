...
public class ChgMarginCmplSlpExcelGenerator {
   public static ByteArrayInputStream customersToExcel(List<ChgMarginCmplSlpModel> reportModels) throws IOException {
...
//         ageCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("#,##0;[RED]-#,##0"));
         ...
         int rowIdx = 1;
         for (ChgMarginCmplSlpModel reportModel : reportModels) {
