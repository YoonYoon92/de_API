...
public class AppSayMsgCouponExcelGenerator {
   public static ByteArrayInputStream customersToExcel(List<AppSayMsgCouponModel> reportModels) throws IOException {
...
//         ageCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("#,##0;[RED]-#,##0"));
         ...
         int rowIdx = 1;
         for (AppSayMsgCouponModel reportModel : reportModels) {
