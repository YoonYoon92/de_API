...
public class AppSayPlusMemInfoExcelGenerator {
   public static ByteArrayInputStream customersToExcel(List<AppSayPlusMemInfoModel> reportModels) throws IOException {
...
//         ageCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("#,##0;[RED]-#,##0"));
         ...
         int rowIdx = 1;
         for (AppSayPlusMemInfoModel reportModel : reportModels) {
