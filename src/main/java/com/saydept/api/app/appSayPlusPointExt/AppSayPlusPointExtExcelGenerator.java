...
public class AppSayPlusPointExtExcelGenerator {
   public static ByteArrayInputStream customersToExcel(List<AppSayPlusPointExtModel> reportModels) throws IOException {
...
//         ageCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("#,##0;[RED]-#,##0"));
         ...
         int rowIdx = 1;
         for (AppSayPlusPointExtModel reportModel : reportModels) {
