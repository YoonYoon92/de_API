...
public class AppSayPlusCouponExcelGenerator {
   public static ByteArrayInputStream customersToExcel(List<AppSayPlusCouponModel> reportModels) throws IOException {
...
//         ageCellStyle.setDataFormat(createHelper.createDataFormat().getFormat("#,##0;[RED]-#,##0"));
         ...
         int rowIdx = 1;
         for (AppSayPlusCouponModel reportModel : reportModels) {
